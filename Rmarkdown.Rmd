...
```{r Leer la Data desde Internet y hacer limpieza de datos, echo=FALSE, message=FALSE, warning=FALSE, paged.print=TRUE}
library("RCurl")
library("dplyr")


#LEER LA DATA 
fifa2019 <- read.csv("recursos/fifa19.csv")

# FILTRAR POR COLUMNAS QUE NECESITO
FIFA19 <- as.data.frame(fifa2019[,c("ID", "X", "Name", "Age", "Nationality", "Height", "Weight", "Overall","Club", "Value", "Wage", "Position","Preferred.Foot","Body.Type")])

#CAMBIAR LOS NOMBRES EN BLANCO EN COLUMNA NAME POR _
...
*Para su estudio, se hace necesario el filtrado de la misma.*
...
```{r Visualización con Leaflet , warning = F, fig.height = 7.5, fig.width = 7, fig.align = 'center'}
