...
print(paste("El Dataset FIFA19 contiene", dim(FIFA19)[1], "filas y", dim(FIFA19)[2], "columnas"))



FIFA19[1:100,c(3,4,6,10,22,27,28)] %>%
  DT::datatable() %>%
...
```{r Analisis Exploratorio de la Data, message=FALSE, warning=FALSE}
...
```{r Nacionalidd de los Jugadores con TreeMap, fig.height=6.5, fig.width=8, warning=FALSE}
...
```{r Mi Jugador Favorito, echo=FALSE, message=FALSE, warning=FALSE}
...
En este apartado, con la ayuda de la API de [**Google Cloud Platform**](https://console.developers.google.com/), he graficado las ubicaciones de Mâcon y del Camp Nou, actual club del jugador en cuestión.

```{r Visualización con Leaflet, fig.height=7.5, fig.width=7, warning=FALSE}
