...
```{r Leer la Data desde Internet y hacer limpieza de datos, echo=FALSE}
...
datatable(head(FIFA19[,c("Name", "Age", "Nationality", "Height", "Weight", "Club", "Wage", "Position")], n=100 ))



#IMPRIMIR LA TABLA ACA
...
```{r CONVERSION DE Wage AND Value, echo=FALSE}
